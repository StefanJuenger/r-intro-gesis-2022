...
allbus_2021 <- read_sav("./data//ZA5280_v1-0-0.sav") %>% 
  remove_all_labels()

allbus_survey <- allbus_2021 %>% 
  select(respid,
         sex:education_cat,
         choice_of_party,
...
The data we use comes from the [Public Use File (PUF) of the GESIS ](https://www.gesis.org/gesis-panel/coronavirus-outbreak/public-use-file-puf). We have selected `r ncol(corona_survey)` variables of interest for our analysis. The dataset includes data for *N* = `r nrow(corona_survey)` respondents.
