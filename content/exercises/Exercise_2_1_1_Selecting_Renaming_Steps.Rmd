...
As in the presentation, we will use data from the [German General Social Survey - allbus_2021 2021](https://search.gesis.org/research_data/ZA5280) for this exercise. You should (have) download(ed) the dataset in `.dta` format and saved it in a folder caller `data` within the folder containing the materials for this workshop. Also remember that it is helpful to consult the [codebook for the data set](https://search.gesis.org/research_data/ZA5280).
