...
Unlike in flat files, such as CSV, the variables now have labels. **If you aim to learn about them, you may want to have a look into the [appendix for labelled data](https://stefanjuenger.github.io/r-intro-gesis-2022/slides/1_4_Appendix_Labelled_Data.html) and then work on the following exercises. For this course, however, this is not necessary.**

```{block, box.title = "2 (optional)", box.body = list(fill = "white"), box.icon = "fa-star"}
