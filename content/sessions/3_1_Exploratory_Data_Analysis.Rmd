...
The [`janitor` package](https://github.com/sfirke/janitor) that we briefly mentioned in the first session on data wrangling also provides the `tabyl()` function for creating frequency and proportion tables:
...
*Note*: For the full range of customization options, check the [online documentation for `tabyl()`](https://sfirke.github.io/janitor/articles/tabyls.html)
]
