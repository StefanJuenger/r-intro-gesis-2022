...
ggss_2021 <- 
  read_stata("./data/ZA5280_v1-0-0.dta")
...
```{r read-spss}
ggss_2021 <-
  haven::read_sav("./data/ZA5280_v1-0-0.sav")
...
```{r get-labels}
sjlabelled::get_label(ggss_2021$agec)
```
...
.tinyish[
```{r get-values}
sjlabelled::get_labels(ggss_2021$agec)
```
]
...
```{r}
ggss_2021$agec <- 
  sjlabelled::set_label(ggss_2021$agec, label = "Age, categorized")
