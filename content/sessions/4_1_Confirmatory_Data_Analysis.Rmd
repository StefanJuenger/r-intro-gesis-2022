...
## Example: Regression tables with the `huxtable` package
...
class: center, middle
.ssmall[
```{r ref.label = "huxtable", echo = FALSE}
```
]

For more details, have a look at the [huxreg vignette](https://hughjonesd.github.io/huxtable/huxreg.html).

---

## Export `huxtable` object to \LaTeX

```{r export-huxtable-latex, eval = FALSE}
quick_latex(huxreg_table, file = "regression_table.tex")
```
