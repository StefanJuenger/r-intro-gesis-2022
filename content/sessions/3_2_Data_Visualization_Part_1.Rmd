...
boxplot(sum_trust ~ agec,
        data = allbus_2021_dvI,
        lwd = 2, 
        main = "Relationship Age and Trust in Institutions",
        xlab = "Age of Respondents",
        ylab = 'Trust in Institutions')

  stripchart(sum_trust ~ agec, vertical = TRUE,
             data = allbus_2021_dvI, 
             method = "jitter",
             add = TRUE,
             pch = 1)
