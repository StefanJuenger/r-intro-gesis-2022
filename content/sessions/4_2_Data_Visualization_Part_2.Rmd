...
```{r log-reg}
linear_model_plain <-
  lm(xenophobia ~ trust + contact + afd, data = allbus_2021_cda)

linear_model_controls <-
  lm(xenophobia ~ age + sex + eastwest + trust + contact + afd, data = allbus_2021_cda)
...
.pull-right[
```{r ref.label = "comparing-model-fit", eval = FALSE, echo = FALSE, out.width = "90%"}
```
]
