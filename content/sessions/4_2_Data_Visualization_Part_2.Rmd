...
linear_model_controls <-
  lm(xenophobia ~ age + sex + region + trust + contact + afd, data = allbus_2021_dvII)
...
plot_models(
  ...
  axis.labels = 
    c(
      "Region (Ref. Western Germany)", "Non-binary (Ref. Male)", 
      "Female (Ref. Male)", "Age", "AfD Vote", "Contact",
      "Social Trust"
    )
) 
```
