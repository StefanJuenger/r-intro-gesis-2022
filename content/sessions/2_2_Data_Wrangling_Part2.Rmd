...
## Join the World Wrangling Federation

```{r ready-wrangle, echo=FALSE, out.width="50%"}
include_picture("./ready-wrangle.png")
```
...
```{r add-constant-base}
allbus_2021$year <- 2021

head(allbus_2021$year)
```
...
Another simple variable transformation is adding or subtracting a constant, which, in `base R`, you can do as follows:

```{r simple-transform-base}
allbus_2021$sex_new <- allbus_2021$sex - 1

table(allbus_2021$sex, allbus_2021$sex_new)
```
...
```{r base-add-type}
allbus_2021$id_char <- as.character(allbus_2021$respid)

typeof(allbus_2021$respid)
typeof(allbus_2021$id_char)
```
...
# [Exercise](https://stefanjuenger.github.io/r-intro-gesis-2022/exercises/Exercise_2_2_1_Create_Transform_Vars.html) time `r ji("weight_lifting_woman")``r ji("muscle")``r ji("running_man")``r ji("biking_man")`

## [Solutions](https://stefanjuenger.github.io/r-intro-gesis-2022/solutions/Exercise_2_2_1_Create_Transform_Vars.html)
...
```{r import-label}
allbus_2021_labelled <- read_sav("./data/allbus_2021/ZA5280_v1-0-0.sav")
```
...
.small[
```{r set-NA-var-base}
sum(is.na(allbus_2021$pa02a))

allbus_2021$pa02a[allbus_2021$pa02a == -42] <- NA
allbus_2021$pa02a[allbus_2021$pa02a == -9] <- NA
...
The `na_if()` function can also be used to recode specific values as `NA` for a whole data set.
...
```{r na-omit}
allbus_2021_complete <- na.omit(allbus_2021_labelled) 

nrow(allbus_2021_complete)
```
...
# [Exercise](https://stefanjuenger.github.io/r-intro-gesis-2022/exercises/Exercise_2_2_2_Missing_Values.html) time `r ji("weight_lifting_woman")``r ji("muscle")``r ji("running_man")``r ji("biking_man")`

## [Solutions](https://stefanjuenger.github.io/r-intro-gesis-2022/solutions/Exercise_2_2_2_Missing_Values.html)
...
# [Exercise](https://stefanjuenger.github.io/r-intro-gesis-2022/exercises/Exercise_2_2_3_Across_Aggregate.html) time `r ji("weight_lifting_woman")``r ji("muscle")``r ji("running_man")``r ji("biking_man")`

## [Solutions](https://stefanjuenger.github.io/r-intro-gesis-2022/solutions/Exercise_2_2_3_Across_Aggregate.html)
...
knitr::include_graphics("https://github.com/rstudio/hex-stickers/blob/master/PNG/forcats.png?raw=true")
```
...
# [Exercise](https://stefanjuenger.github.io/r-intro-gesis-2022/exercises/Exercise_2_2_4_Factors_Conditional_Recode.html) time `r ji("weight_lifting_woman")``r ji("muscle")``r ji("running_man")``r ji("biking_man")`

## [Solutions](https://stefanjuenger.github.io/r-intro-gesis-2022/solutions/Exercise_2_2_4_Factors_Conditional_Recode.html)
...
knitr::include_graphics("https://github.com/rstudio/hex-stickers/blob/master/PNG/stringr.png?raw=true")
```
...
knitr::include_graphics("https://github.com/rstudio/hex-stickers/blob/master/PNG/lubridate.png?raw=true")
```
